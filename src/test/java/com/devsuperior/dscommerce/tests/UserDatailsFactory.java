...
public class UserDatailsFactory {
	...
	public static List<UserDetailsProjection> createCustomClientUser(String username){
		...
		list.add(new UserDatailsImpl(username, "123", 1L, "ROLE_CLIENT"));
		return list;
	}
	...
	public static List<UserDetailsProjection> createCustomAdminUser(String username){
		...
		List<UserDetailsProjection> list = new ArrayList<>();
		list.add(new UserDatailsImpl(username, "123", 2L, "ROLE_ADMIN"));
		return list;
	}	
...
class UserDatailsImpl implements UserDetailsProjection{
	...
	public UserDatailsImpl(String username, String password, Long roleId, String authority) {		
