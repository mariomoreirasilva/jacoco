...
public class AuthServiceTests {
	...
	void setup() throws Exception {
		...
		selfClient = UserFactory.createCustomUserClientUser(1L, "Bob");
		otherClient = UserFactory.createCustomUserClientUser(2L, "Ana");
	...
	@Test
	public void validateSelfOrAdminThrowsForbiddenExceptionWhenClientOtherLogger() {
